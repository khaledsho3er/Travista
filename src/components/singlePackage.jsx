...
function SinglePackage() {
  ...
  const handleAdultsChange = (value) => setAdults((prev) => Math.max(0, prev + value));
  const handleChildrenChange = (value) => setChildren((prev) => Math.max(0, prev + value));
  ...
  return (
    <Slide direction="up" in={open} mountOnEnter unmountOnExit>
      ...
      >
        ...
        {currentStep === 1 ? <ComponentOne /> : currentStep === 2 ? <ComponentTwo /> : <ComponentThree />}
      </Box>
    </Slide>
  );
}
