...
const HotelManagement = () => {
  ...
  const fetchHotels = async () => {
    try {
      const response = await axios.get("https://api.travistasl.com/api/hotels");
  ...
  const handleSave = async () => {
    ...
    try {
      if (selectedHotel) {
        await axios.put(
          `https://api.travistasl.com/api/hotels/${selectedHotel.hotelId}`,
          hotelData
        );
        toast.success("Hotel updated successfully!");
      } else {
        await axios.post("https://api.travistasl.com/api/hotels", hotelData);
  ...
  const handleDelete = async (hotelId) => {
    ...
    try {
      await axios.delete(`https://api.travistasl.com/api/hotels/${hotelId}`);
