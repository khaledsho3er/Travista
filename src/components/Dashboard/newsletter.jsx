...
const NewsletterManagement = () => {
  ...
  const fetchSubscribers = async () => {
    try {
      const response = await axios.get(
        "https://api.travistasl.com/api/newsletter/subscribers"
      );
  ...
  const handleSubscribe = async () => {
    ...
    try {
      const response = await axios.post(
        "https://api.travistasl.com/api/newsletter/subscribe",
        { email }
      );
  ...
  const handleUnsubscribe = async (subscriberEmail) => {
    try {
      const response = await axios.put(
        "https://api.travistasl.com/api/newsletter/unsubscribe",
  ...
  const handleDelete = async (subscriberEmail) => {
    if (!window.confirm("Are you sure you want to delete this subscriber?"))
      return;
    try {
      await axios.delete("https://api.travistasl.com/api/newsletter/delete", {
